import { BlockProps, ExperienceItem } from '@/core/resume/types';
import ReactMarkdown from 'react-markdown';
import remarkGfm from 'remark-gfm';

interface ExperienceBlockProps extends BlockProps {
    items: ExperienceItem[];
}

export function ExperienceBlock({ items, renderMode }: ExperienceBlockProps) {
